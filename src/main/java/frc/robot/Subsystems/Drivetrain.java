...
public class Drivetrain extends SubsystemBase {
    ...
    // number 4 should be a talon, i did not rename it because i am lazy
    public static TalonSRX driveRightVictor = new TalonSRX(4);
    ...
    public Drivetrain() {
        ...
        driveLeftSpark.burnFlash();
        driveRightSpark.burnFlash();
    }
    ...
    public void setDriveMotors(double forward, double turn) {
        ...
        // THIS DOES TANK DRIVE
        // driveLeftSpark.set(forward);
        // driveLeftVictor.set(ControlMode.PercentOutput, forward);
        // driveRightSpark.set(turn);
        // driveRightVictor.set(TalonSRXControlMode.PercentOutput, turn);
    }

    // // The robot's drive
    // private final DifferentialDrive dt = new DifferentialDrive(leftSideMotors,
    // rightSideMotors);
